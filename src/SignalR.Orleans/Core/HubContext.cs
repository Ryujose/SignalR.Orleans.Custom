...
public class HubContext<THub> where THub : Hub
{
    ...
    /// <summary>
    ///     Gets an <see cref="IHubGroupMessageInvoker" /> that allows you to invoke methods on a group of connections in the
    ///     named group.
    /// </summary>
    ...
    /// <summary>
    ///     Gets an <see cref="IHubGroupMessageInvoker" /> that allows you to invoke methods on a group of connections
    ///     belonging to the given authenticated user.
    /// </summary>
