...
//             using (var client = new TestClient())
//             {
//                 var groupGrain = _fixture.Client.GetGroupGrain("MyHub", "dre");
...
//                 //var result = await groupGrain.Count();
...
//                 // Give the disconnection stream message time to be processed by the group grain.
